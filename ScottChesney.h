...
public:
    ...
    /* This shoudl oinly be used for plotting */
...
private:
    ...
    std::vector<double> generateRiskNeutralPricePath(double toDate, int nSteps, std::vector<double>& vol_path, std::vector<double>& spot_draws) const;
